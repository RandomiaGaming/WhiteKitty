...
#if UNITY_EDITOR
[CustomEditor(typeof(PixelPerfectSpriteshape))]
public class PixelPerfectSpriteshapeEditor : Editor
{
    public override void OnInspectorGUI()
    {
        base.OnInspectorGUI();
        if (GUILayout.Button("Regenerate Spriteshapes"))
        {
            PixelPerfectSpriteshape t = (PixelPerfectSpriteshape)target;
            t.Regenerate();
        }
    }
}
